...
function ProfileInfo({ userProfile }) {
  ...
  return (
    <div className='w-full lg:w-1/3 flex flex-col gap-2 md:sticky md:top-10'>
      <div className='bg-glass rounded-lg px-6 py-4 flex flex-col  gap-3'>
      ...
      <div className='flex flex-wrap gap-2 mx-4'>
        {/* Followers Count */}
        <div className='flex items-center gap-2 bg-glass rounded-lg p-2 flex-1 min-w-28'>
